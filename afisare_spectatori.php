...
session_start();
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<td>
                        <form method='post' action='stergere_spectatori.php'>
                            <input type='hidden' name='spectator_id' value='" . $row["ID_spectator"] . "'>
                            <input type='submit' value='Șterge'>
                        </form>
                      </td>";
                      echo "<td>
                        <form method='post' action='edit_spectatori.php'>
                            <input type='hidden' name='id_spectator' value='" . $row["ID_spectator"] . "'>
                            <input type='submit' value='Editare'>
                        </form>
                      </td>";
                echo "</tr>";
            }
            echo "<form method='post' action='filtrare_spectatori.php'>
                            <form method='post' action='filtrare_spectatori.php'>
