...
session_start();
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<td>
                        <form method='post' action='stergere_recenzii.php'>
                            <input type='hidden' name='recenzie_id' value='" . $row["ID_recenzie"] . "'>
                            <input type='submit' value='Șterge'>
                        </form>
                      </td>";
                      echo "<td>
                        <form method='post' action='edit_recenzii.php'>
                            <input type='hidden' name='id_recenzie' value='" . $row["ID_recenzie"] . "'>
                            <input type='submit' value='Editare'>
                        </form>
                      </td>";
                echo "</tr>";
            }
            echo "<form method='post' action='filtrare_recenzii.php'>
                            <form method='post' action='filtrare_recenzii.php'>
